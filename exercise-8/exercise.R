...
m.pu <- pulitzer %>% select(Newspaper, Pulitzer.Prize.Winners.and.Finalists..2004.2014) %>% select(Newspaper, max(Pulitzer.Prize.Winners.and.Finalists..2004.2014)) %>% 
